 ...
 *
 *   Content: C++ header file of kconsens_instance_dirtypairs_based
...
#ifndef KCONSENS_INSTANCE_DIRTYPAIRS_BASED_H
#define KCONSENS_INSTANCE_DIRTYPAIRS_BASED_H
...
*/
class kconsens_instance_dirtypairs_based : public kconsens_instance_candidate_relations_based
{
public:
  // const & dest
  kconsens_instance_dirtypairs_based ( stringstream &outdebug );
  ~kconsens_instance_dirtypairs_based();
